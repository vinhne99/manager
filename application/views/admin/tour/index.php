<div class="page-title">
    <div class="title_left">
        <h3>Trang chủ - Danh sách tour</h3>
    </div>
</div>
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <a href="<?php echo base_url(); ?>admin/tour/create"  class="btn btn-primary"><i class="fa fa-plus"></i> Thêm mới tour</a>
...
function load_tour(page){
    $.ajax({
        type: "POST",
        url:"<?php echo base_url(); ?>admin/tour/ajax_tour",
        data: {'page': page },
        error: function(data){
            //alert('error test');
        },
    ...
    function delete_tour(id){
       // $(".pro-" + id).find(".loading-img").show();
        $.ajax({
            type: "POST",
            url:"<?php echo base_url(); ?>admin/tour/delete",
            data: { 'id' : id  },
            dataType: 'json',
            error: function(data){
                //alert('error test');
