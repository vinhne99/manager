...
foreach ($tours as $tour): ?>
    <tr class="even pointer pro-<?php echo $tour->product_id; ?>">
        <td class="a-center ">
            <input type="checkbox" class="flat" name="table_records">
        </td>
        <td class=" "><img height="40px" src="<?php echo get_image_product($tour->product_id, $size_img[0][0]); ?>"></td>
        ...
        <td class=" last">
            <div class="btn-group pull-right">
                ...
                <ul class="dropdown-menu" role="menu">
                    <li>
                        <a href="<?php echo base_url();  ?>admin/tour/edit/<?php echo $tour->product_id; ?>"><i class="fa fa-edit"></i> Sửa</a>
                    </li>
                    <li>
                        <a onclick="delete_tour(<?php echo $tour->product_id; ?>)" href="#"><i class="fa fa-remove"></i> Xóa</a>
                    </li>
                </ul>
            </div>
        </td>
