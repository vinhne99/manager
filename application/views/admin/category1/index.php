...
<div id="change-content" data-backdrop="static" data-keyboard="false" class="modal fade " tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <?php  $this->load->view("admin/category1/ajax_load_content"); ?>
        </div>
    </div>
</div>
...
<script>
    ...
    function load_tree(){
        $( "#sortable ul" ).sortable({
            ...
            update: function(event, ui){
                ...
                $.ajax({
                    type: "POST",
                    url:"<?php echo base_url(); ?>admin/category1/order_category",
    ...
    function edit_category(id){
      ...
      //  element.find(".modal-content").html("<div class='loading-content'>Đang tải dữ liệu, vui lòng đợi....</div>");
        ...
        $.ajax({
            type: "POST",
            url:"<?php echo base_url(); ?>admin/category1/edit/" + id,
            data: {'id': id },
            dataType: 'json',
            error: function(data){
                //alert('error test');
    ...
    $("#save_edit_category").click(function(){
        ...
        $.ajax({
            type: "POST",
            url:"<?php echo base_url(); ?>admin/category1/update_category",
    ...
    function delete_category(id){
        ...
        $.ajax({
            type: "POST",
            url:"<?php echo base_url(); ?>admin/category1/delete_category",
            data: {'id': id },
            error: function(data){
                //alert('error test');
            },
