<?php $user =  $this->session->userdata('validated');  ?>
...
<head>
    ...
    <script src="<?php echo base_url(); ?>assets/admin/js/main.min.js"></script>
        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                ...
                <div class="navbar nav_title" style="border: 0;">
                    <a href="<?php echo base_url(); ?>admin/dashboard" class="site_title"><i class="fa fa-paw"></i> <span>Administrator</span></a>
                </div>
                ...
                <div class="profile">
                    <div class="profile_pic">
                        <img width="80px" src="<?php echo base_url(); ?>assets/admin/images/admin.png" alt="">
                    </div>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                <img src="<?php echo base_url(); ?>assets/admin/images/admin.png" alt=""><?php echo  $user->username; ?>
                                <span class=" fa fa-angle-down"></span>
                            </a>
                            <ul class="dropdown-menu dropdown-usermenu animated fadeInDown pull-right">
                                <li><a onclick="$('#change-password').modal('show')" href="javascript:;"> Thay đổi mật khẩu</a>
                                </li>
                                <li>
                                    <a target="_blank" href="">Trợ giúp</a>
                                </li>
                                <li><a href="<?php echo base_url(); ?>admin/dashboard/logout"><i class="fa fa-sign-out pull-right"></i> Đăng xuất</a>
                                </li>
                            </ul>
                        </li>
        ...
        <div class="right_col" role="main">
            ...
            <footer>
                <div class="copyright-info">
                    <p class="pull-right">Bảng quyền <?php echo date("Y"); ?>
                    </p>
                </div>
                <div class="clearfix"></div>
            </footer>
...
<!-- modals -->
<!-- Large modal -->
<div id="change-password" class="modal fade " tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <form class="form-horizontal form-label-left" action="<?php echo base_url();?>admin/setting" method="post" >
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="first-name">Mật khẩu hiện tại: <span class="required">*</span>
                        </label>
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <input type="password"   name="password_old" required="required" class="form-control col-md-7 col-xs-12" >
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="first-name">Mật khẩu mới: <span class="required">*</span>
                        </label>
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <input type="password"   name="password_new" required="required" class="form-control col-md-7 col-xs-12" >
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="first-name">Nhập lại mật khẩu mới: <span class="required">*</span>
                        </label>
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <input type="password"   name="password_new_re" required="required" class="form-control col-md-7 col-xs-12" >
                        </div>
                    </div>
            ...
            <div class="modal-footer from-action">
                ...
                <button id="update_password"  type="button"  class="btn btn-primary pull-right">Cập nhật</button>
            </div>
            </form>
        </div>
    </div>
...
<div id="change-content-md" class="modal fade " tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
        </div>
    </div>
...
<div id="image-manager"  data-backdrop="static" data-keyboard="false" class="modal fade  in" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span>
                </button>
                <h4 class="modal-title title-cg" id="myModalLabel">Quản lý hình ảnh</h4>
            </div>
            <div class="modal-body content-manager-image"></div>
            <div class="modal-footer from-action">
                <button type="button" class="btn btn-default" data-dismiss="modal">Thoát</button>
            </div>
        </div>
...
<!-- flot js -->
<!--[if lte IE 8]><script type="text/javascript" src="<?php echo base_url(); ?>assets/admin/js/excanvas.min.js"></script><![endif]-->
...
<!-- PNotify -->
<script type="text/javascript" src="<?php echo base_url(); ?>assets/admin/js/notify/pnotify.core.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>assets/admin/js/notify/pnotify.buttons.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>assets/admin/js/notify/pnotify.nonblock.js"></script>
