<form class="form-product form-horizontal form-label-left" >
    ...
    <div class="form-group">
        ...
        <div class="col-md-10 col-sm-10 col-xs-12">
            <input type="text" placeholder="Vui lòng nhập tên sản phẩm" value="<?php if (isset($product)) echo $product->title;  ?>" name="title" required="required" class="form-control col-md-7 col-xs-12" >
        </div>
    </div>
    <div class="form-group">
...
<script >
    ...
    function delete_img(id){
        ...
        $.ajax({
            ...
            data: {'product_id': '<?php  if (isset($product)) echo $product->id;  ?>',
                    'id' : id
                    },
            dataType: 'html',
            error: function(data){
